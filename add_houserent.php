        ...
        <form enctype="multipart/form-data" class="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          ...
          <div class="fam_bac_sub">
            <div class="fam_bac_sub_inner">
              <div class="address">
                <input type="text" class="form-control" name="address" placeholder="House location">
              </div>
              <div class="rent">
                ...
                <div id="price_tab">
                  ...
                  <div id="fixed">
                    <label for="amount_fixed" style="font-weight:bold;color:coral;">Rs.</label>
                    <input type="text" id="amount_fixed" name="rental_value" readonly
                      style="border:0; color:#f6931f; font-weight:bold;">
                    <div id="slider-range-max" class="myrange"
                      title="Tap left or right button to set more precise value."></div>
                  </div>
                </div>
              ...
              <div class="image_input">
                <p>Add image of your House(Optional and Maximum 3)<span class="hidden_plus_btn"> <i
                      class="fas fa-plus"></i> </span></p>
                <div class="inner_image_input">
                  <div class="main_input">
                    <input type="file" style="float:left;" class="form-control-file" name="img_1"
              ...
              <div class="description">
                <textarea class="form-control" rows="8" cols="80" placeholder="Description(Optional)"
                  name="description"></textarea>
              </div>
              <p class="text-center" style="margin-top:10px;">
                <input type="submit" style="margin-bottom:0px;" class="btn btn-info" name="fam_add_rent"
                  value="Add For Rent">
              </p>
            </div>
          </div>
            ...
            <div class="mess_inner">
              ...
              <div class="rent">
                ...
                <div id="price_tab_mess">
                  ...
                  <div id="fixed">
                    <label for="amount_mess" style="font-weight:bold;color:coral;">Rs.</label>
                    <input type="text" id="amount_mess" readonly style="border:0; color:#f6931f; font-weight:bold;">
                    <div id="slider-range-mess" class="myrange"
                      title="Tap left or right button to set more precise value."></div>
                  </div>
                  <div id="range">
                    <input type="text" id="amount_range_mess" readonly
                      style="border:0; color:#f6931f; font-weight:bold;">
                    <div id="slider_range_formess" class="myrange"
                      title="Tap left or right button to set more precise value."></div>
                  </div>
                </div>
              </div>
              ...
              <div class="image_input">
                <p>Add image of your House(Optional)<span class="hidden_plus_btn"> <i class="fas fa-plus"></i> </span>
                </p>
                <div class="inner_image_input">
                  <div class="main_input">
                    <input type="file" style="float:left;" class="form-control-file" name="image1"
                      placeholder="Add Image(Optional)">
                    <span class="plus_btn"> <i class="fas fa-plus"></i> </span>
                    <span class="minus"> <i class="fas fa-minus"></i> </span>
                  </div>
