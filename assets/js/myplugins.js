$(document).ready(function(){
  ...
  $( "#slider_range_formess" ).slider({
    ...
    slide: function( event, ui ) {
      $( "#amount_range_mess" ).val( "Rs." + ui.values[ 0 ] + " - Rs." + ui.values[ 1 ] );
    }
  });
  $( "#amount_range_mess" ).val( "Rs." + $( "#slider_range_formess" ).slider( "values", 0 ) +
   " - Rs." + $( "#slider_range_formess" ).slider( "values", 1 ) );
