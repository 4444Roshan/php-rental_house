        ...
        <div class="well search_card card-body">
          <form class="search_house_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div id="range">
              ...
              <input type="text" id="input_range" name="rental_value" readonly
          ...
          <div class="single_house_inner card-body">
            <div class="house_title">
              <p style="font-weight:600;"> <i class="fas fa-map-marker-alt"></i>
                <?php echo ucfirst($value['address']); ?> </p>
  ...
  $(function () {
    $("#main_range").slider({
      ...
      slide: function (event, ui) {
        $("#input_range").val("R" + ui.values[0] + " - R" + ui.values[1]);
      }
    });
    $("#input_range").val("R" + $("#main_range").slider("values", 0) +
      " - R" + $("#main_range").slider("values", 1));
  });
</script>