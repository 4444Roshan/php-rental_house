...
<?php
 ...
 <?php
   if(($_SERVER["REQUEST_METHOD"] === "POST") && isset($_POST['delhouse'])){
    ...
    //  echo "<script>window.location.href='owner_profile.php</script>";
   }
  ?>
          ...
          <div class="single_action">
            ...
            <?php } ?>
              ...
              <form action="<?php echo $_SERVER['PHP_SELF'].'?house_id='.$houseid; ?>" method="post" style="margin-top:10px;">
                ...
                <button type="submit" class="btn btn-danger" onclick="return confirm('Are you Sure to Delete?');" name="delhouse" value="" href='owner_profile.php?owner_id=<?php echo $ownerid ?>'>Delete This House</button>
              </form>
