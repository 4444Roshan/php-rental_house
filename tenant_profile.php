        ...
        <div class="left_profile_inner">
          <div class="profile_title">
            <div class="profile_image">
              <img src="<?php
              if (isset ($user->pic) && $user->pic != '') {
                echo $user->pic;
              } else {
                echo 'assets/images/owner.png';
              } ?>"
                class="img-thumbnail" alt="Owner">
            </div>
            <p class="text-center"> <i class="fas fa-user" style="margin-right:5px;"></i>
          ...
          <div class="profile_nav">
            <ul class="main_profile_nav">
              ...
              <li> <i class="fas fa-id-card-alt"></i> <strong>NID:</strong>
                <?php if (isset ($user->nid))
                  echo $user->nid; ?>
              </li>
              <li> <i class="fas fa-angle-double-right"></i> <strong>Description:</strong>
            ...
            if (Session::get('user_id') == $id) {
              ...
              <ul class="extra_nav">
                <li> <a class="btn btn-primary" href="editprofile.php?id=<?php echo Session::get('user_id'); ?>">Edit
                    Profile</a> </li>
              </ul>
            <?php } ?>
          </div>
            ...
            <div class="available_house col-sm-12">
              ...
              <div class="all_house row">
                ...
                if (count($ava_home) > 0) {
                    ...
                    <div class="single_house card">
                      <div class="single_house_inner card-body">
                        ...
                        if ($house['active_status'] == 1) {
                          ...
                          ?>
                          <p style="overflow:hidden;">Booked By <a href=""
                              style="font-weight:strong;margin:0px;float:none;border:none;">
                              <?php echo $getuser->fname . ' ' . $getuser->lname; ?>
                            </a> </p>
                          <?php
                        } else if (is_array($total_req) && count($total_req) > 0) { ?>
                            <p
                              style="display:inline-block;margin-top:10px;padding:4px 6px;color:#fff;border-radius:3px;background-color:cornflowerblue;">
                              <span style="margin-left:5px;" class="badge badge-light">
                              <?php echo count($total_req); ?>
                              </span> request !</p>
                        <?php } ?>
                  ...
                  echo "You havn't any availabe/free room.";
                } ?>
